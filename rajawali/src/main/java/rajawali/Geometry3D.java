...
public class Geometry3D {
    ...
    public String toString() {
        ...
        if (mTextureCoords != null)
            buff.append(", uvs: ").append(mTextureCoords.capacity()).append("\n");

        if (mVertexBufferInfo != null)
            buff.append("vertex buffer handle: ").append(mVertexBufferInfo.bufferHandle).append("\n");
        if (mIndexBufferInfo != null)
            buff.append("index buffer handle: ").append(mIndexBufferInfo.bufferHandle).append("\n");
        if (mNormalBufferInfo != null)
            buff.append("normal buffer handle: ").append(mNormalBufferInfo.bufferHandle).append("\n");
        if (mTexCoordBufferInfo != null)
            buff.append("texcoord buffer handle: ").append(mTexCoordBufferInfo.bufferHandle).append("\n");
        if (mColorBufferInfo != null)
            buff.append("color buffer handle: ").append(mColorBufferInfo.bufferHandle).append("\n");
    ...
    public void destroy() {
        ...
        if (mVertexBufferInfo != null && mVertexBufferInfo.buffer != null) {
            mVertexBufferInfo.buffer.clear();
            mVertexBufferInfo.buffer = null;
        }
        if (mIndexBufferInfo != null && mIndexBufferInfo.buffer != null) {
            mIndexBufferInfo.buffer.clear();
            mIndexBufferInfo.buffer = null;
        }
        if (mColorBufferInfo != null && mColorBufferInfo.buffer != null) {
            mColorBufferInfo.buffer.clear();
            mColorBufferInfo.buffer = null;
        }
        if (mNormalBufferInfo != null && mNormalBufferInfo.buffer != null) {
            mNormalBufferInfo.buffer.clear();
            mNormalBufferInfo.buffer = null;
        }
        if (mTexCoordBufferInfo != null && mTexCoordBufferInfo.buffer != null) {
            mTexCoordBufferInfo.buffer.clear();
